...
/*****************************************************************
  ...
  This is a modified version of Alex Beaver's original AutonConversionFactors class. Check it out here: https://www.alexbeaver.com/blog/wpilib-trajectory-guide
  Changes include:
  - Correct package line
  - Renamed long methods (ex: convertTalonSRXNativeUnitsToWPILibTrajecoryUnits to TalonToWPI)
...
public class AutonConversionFactors {
     ...
     * @return
     */
    public static final double TalonToWPI(double talonVelocity, double wheelDiameter, boolean usingMetric, int ticksPerRevolution){
     ...
     * @return
     */
    public static final double WPIToTalon(double metersPerSecond, double wheelDiameter, boolean givenMetric, int ticksPerRevolution){
