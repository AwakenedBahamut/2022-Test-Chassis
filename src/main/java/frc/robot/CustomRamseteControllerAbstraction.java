...
/******************************************************************************
  ...
  Another class by Alex Beaver, from step 4 of his Trajectory guide (https://www.alexbeaver.com/blog/wpilib-trajectory-guide)
  This class extends the RameseteController and it provides debugging power as it updates values to the SmartDashboard.
  You can decide if this class is necessary or not...
  - Only the package declaration is changed. 
  
  IMPORTANT: I believe Alex Beaver meant to name his first constructor "CustomRamseteControllerAbstraction," so we might need to change that portion (line 39) 
  IMPORTANT 2: The "calculate" method has been overridden
